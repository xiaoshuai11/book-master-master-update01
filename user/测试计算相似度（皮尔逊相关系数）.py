...
allUserMovieStarList = [
    ...
    [1, 1, 1, 1, 1, 0, 0],
    [1, 1, 0, 1, 0, 1, 1]]
pcc_matrix = np.corrcoef(allUserMovieStarList)
pcc_matrix = np.corrcoef(allUserMovieStarList) * 0.5 + 0.5
print(pcc_matrix)
...
cc_zscore_corr = np.corrcoef(aa,bb)  #相关系数矩阵
print(cc_zscore_corr)

users = {}
data = [[1,4,15],[1,5,1],[1,3,6],[1,4,3],
        [2,2,2],[3,3,3],
        [4,4,4],[5,5,5]]
for lines in data:
